...
void evse_board_supportImpl::ready() {
    // Use configurable values from manifest.yaml instead of hardcoded defaults
    types::evse_board_support::HardwareCapabilities capabilities = {
        mod->config.max_current_A_import,                              // max_current_A_import (configurable)
        mod->config.min_current_A_import,                              // min_current_A_import (configurable)
        3,                                                             // max_phase_count_import
        1,                                                             // min_phase_count_import
        mod->config.max_current_A_export,                              // max_current_A_export (configurable)
